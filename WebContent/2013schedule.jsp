...
<body>
	<h1>The schedule of 2013 regular season is as following:</h1>
	<% 
	GetGameInforBySeason client = new GetGameInforBySeason();

	ArrayList<Games> games = client.findGamesBySeason("2013");
	for (Games game : games) {
		out.println("<br/>" + game.getScheduled()  + "<br/>");
		out.println("<br/>" + game.getId() + "<br/>");
	}
	ArrayList<Home> homes = client.findHomeBySeason("2013");
	for (Home home : homes) {
